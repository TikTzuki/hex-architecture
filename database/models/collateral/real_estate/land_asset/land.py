...
class CollReLandOwner(BaseModel):
    ...
    id = Column(NUMBER(asdecimal=False), primary_key=True)
    re_land_id = Column(ForeignKey('v_los_coll_re_land.id'), comment='Bất động sản, tham chiếu qua bảng LOS_COLL_RE_LAND')
...
class CollReLandOwnerAuth(BaseModel):
    ...
    id = Column(NUMBER(asdecimal=False), primary_key=True)
    re_land_owner_id = Column(ForeignKey('v_los_coll_re_land_owner.id'), comment='Tham chiếu qua bảng LOS_COLL_RE_LAND_OWNER để biết ai là người uỷ quyền')
...
class CollReLandCert(BaseModel):
    ...
    id = Column(NUMBER(asdecimal=False), primary_key=True)
    re_land_id = Column(ForeignKey('v_los_coll_re_land.id'), comment='Tham chiếu qua bảng LOS_COLL_RE_LAND để biết mảnh đất nào')
...
class CollReLandCertItem(BaseModel):
    ...
    id = Column(NUMBER(asdecimal=False), primary_key=True)
    re_land_cert_id = Column(ForeignKey('v_los_coll_re_land_cert.id'), comment='Tham chiếu qua bảng COLL_RE_LAND_CERT để biết người này thuộc về giấy chứng nhận nào')
