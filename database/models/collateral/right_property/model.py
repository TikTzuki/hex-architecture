...
class CollRightPropertyOwner(BaseModel):
    ...
    id = Column(NUMBER(asdecimal=False), primary_key=True)
    right_property_id = Column(ForeignKey('v_los_coll_right_property.id'), comment='Tham chiếu qua bảng LOS_COLL_RIGHT_PROPERTY')
    ...
    right_property = relationship('VLosCollRightProperty')
